...
## Правки
- Если больше одной большой буквы то кидать предупредление что переведется в нижний регист, можно кинуть окно yes no
- Предупреждение про неправильный формат что переведется в правильный
- Поиск по дате рожления
- Хранить последний при удалении
- Хранить последний после редактирования
- Предупреждение про дубликаты

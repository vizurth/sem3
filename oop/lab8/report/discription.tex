...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{myPhoto/format_warning.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{myPhoto/contact_added.png}
...
Пользователь вводит имя, начинающееся с дефиса: "-Иван". Система выводит ошибку валидации (см. рисунок~\ref{fig:validation_error}).

\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{myPhoto/validation_error.png}
...
Пользователь вводит телефон без знака "+": "79993332211". \\
Класс \texttt{ContactValidator} автоматически добавляет "+" в начало, преобразуя номер в "+79993332211".
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{myPhoto/number_plus.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{myPhoto/number_limit.png}
    \end{minipage}
...
Пользователь вводит email без символа "@": "ivanovexample.com"(см. рис \ref{fig:err_email}). Система выводит ошибку:
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{myPhoto/err_email.png}
    \caption{Некорректный email}
    \label{fig:err_email}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{myPhoto/contact_edited.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{myPhoto/delete_confirmation.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{myPhoto/contact_deleted.png}
...
\begin{itemize}
    ...
    \item Отображается \texttt{QComboBox} с типами сравнения: "Точная дата", "Год", "Месяц и год".
\end{itemize}
...
Пользователь выбирает дату "08.01.2006" и тип "Точное совпадение". В таблице отображаются только контакты, родившиеся именно в этот день.

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{myPhoto/current_date.png}
    \caption{Результат поиска по дате (08.01.2006)}
    \label{fig:date_search_result}
\end{figure}

\textbf{Пример 2: Год}

Пользователь выбирает дату "08.01.2006" и тип "Год. В таблице отображаются все контакты, родившиеся в 2006 году.

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{myPhoto/date_year_search.png}
    \caption{Результат поиска по году рождения (2006)}
    \label{fig:date_search_result}
\end{figure}

\textbf{Пример 3: Месяц и год}

Пользователь выбирает дату "08.12.2006" и тип "Месяц и год". В таблице отображаются все контакты, родившиеся в декабре 2006 года.

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{myPhoto/date_year_month.png}
    \caption{Результат поиска по месяцу и году (декабрь 2005)}
    \label{fig:date_search_result}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{myPhoto/undo_action_after.png}
    \caption{Таблица после отмены дейсвия}
    \label{fig:undo_action_after}
\end{figure}
